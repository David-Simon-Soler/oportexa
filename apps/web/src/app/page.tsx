...
export const metadata: Metadata = { title: "Encuentra oportunidades públicas", description: "Busca y explora subvenciones y ayudas públicas a partir de información publicada por la BDNS." };
