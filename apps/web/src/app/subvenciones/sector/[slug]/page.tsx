...
export async function generateMetadata({ params }: Props): Promise<Metadata> { const entity = await getSectorBySlug((await params).slug); return entity ? { title: `Subvenciones de ${entity.label}`, description: `Convocatorias del sector ${entity.label} en los datos actualmente incorporados por Oportexa.`, alternates: { canonical: `/subvenciones/sector/${entity.slug}` } } : {}; }
