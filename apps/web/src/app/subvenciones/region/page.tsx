...
export const metadata: Metadata = { title: "Subvenciones por región", description: "Explora convocatorias por región en los datos actualmente incorporados por Oportexa.", alternates: { canonical: "/subvenciones/region" } };
